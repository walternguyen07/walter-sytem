<!--Action Button-->
@if( Active::checkUriPattern( 'admin/websites' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.websites.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.websites.all' ) }}
            </a>
        </li>
        @permission( 'create-website' )
            <li>
                <a href="{{ route( 'admin.websites.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.websites.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
