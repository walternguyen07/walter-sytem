...
return [
	...
	"websites" => [
	"already_exists" => "That Website already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Website. Please try again.",
	"delete_error" => "There was a problem deleting this Website. Please try again.",
	"not_found" => "That Website does not exist.",
	"update_error" => "There was a problem updating this Website. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://demo1.johnnguyenn.com/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
